                    ...
                    <td bgcolor="#fff" style="padding:25px">
                        <table width="550" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <h4>hello {!! $data['name'] !!},Let's verify your email <strong>{!! $data['email'] !!},</strong> so you can start with {{$settings->site_title}}</h4>
                                <p  align="center" ><a href="{!! $data['link'] !!}" target="_blank" style="color:#fff; font-family: arial, sans-serif; font-size: 18px;background-color:#0d2ea0;padding: 10px;">  Verify Your Account</a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
