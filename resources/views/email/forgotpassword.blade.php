                    ...
                    <td bgcolor="#fff" style="padding:25px">
                        <table width="550" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <h4> hello  <strong>{!! $data['email'] !!} ,</strong>in case recover your password, please reset your password</h4>
                                <p  align="center" ><a href="{!! $data['link'] !!}" target="_blank" style="color:#fff; font-family: arial, sans-serif; font-size: 18px;background-color:#0d2ea0;padding: 10px;">Reset Account</a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
